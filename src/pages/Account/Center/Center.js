...
@connect(({loading, user, project}) => ({
    ...
    currentUserLoading: loading.effects['login/login'],
    project,
                ...
                <Row gutter={24}>
                    <Col lg={7} md={24}>
                        <Card bordered={false} style={{marginBottom: 24}}>
                            {currentUserInfo && Object.keys(currentUserInfo).length ? (
                                <div>
                                    ...
                                    <div className={styles.tags}>
                                        ...
                                        {tagsMockData.concat(newTags).map(item => (
