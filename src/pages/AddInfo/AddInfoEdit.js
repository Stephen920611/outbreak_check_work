            ...
            new Promise((resolve, reject) => {
                ...
                if (response.code === 0) {
                    ...
                    let formValue = {
                        ...
                        backFromWhere: T.lodash.isUndefined(activities[0]) ? '' : activities[0].backFromWhere,
                        ...
                        backType: T.lodash.isUndefined(activities[0]) ? '' : activities[0].backType,
                        carNum: T.lodash.isUndefined(activities[0]) ? '' : activities[0].carNum,
                        wayCity: T.lodash.isUndefined(activities[0]) ? '' : activities[0].wayCity,

                        isTouchSuspect: T.lodash.isUndefined(touch[0]) ? '' : touch[0].isTouchSuspect,	  //是否
                        suspectName: T.lodash.isUndefined(touch[0]) ? '' : touch[0].suspectName,
                        suspectIdCard: T.lodash.isUndefined(touch[0]) ? '' : touch[0].suspectIdCard,
                        suspectTime: T.lodash.isUndefined(touch[0]) ? '' : (touch[0].suspectTime === null || touch[0].suspectTime === '') ? null : T.moment( new Date(touch[0].suspectTime).getTime()),
                        suspectPoint: T.lodash.isUndefined(touch[0]) ? '' : touch[0].suspectPoint,

                        isTouchIntimate: T.lodash.isUndefined(touch[0]) ? '' : touch[0].isTouchIntimate,	  //是否
                        intimateName: T.lodash.isUndefined(touch[0]) ? '' : touch[0].intimateName,
                        intimateIdCard: T.lodash.isUndefined(touch[0]) ? '' : touch[0].intimateIdCard,
                        intimateTime: T.lodash.isUndefined(touch[0]) ? '' : (touch[0].intimateTime === null || touch[0].intimateTime === '') ? null : T.moment( new Date(touch[0].intimateTime).getTime()),
                        intimatePoint: T.lodash.isUndefined(touch[0]) ? '' : touch[0].intimatePoint,

                        isTouchInfector: T.lodash.isUndefined(touch[0]) ? '' : touch[0].isTouchInfector,	  //是否
                        infectorName: T.lodash.isUndefined(touch[0]) ? '' : touch[0].infectorName,
                        infectorIdCard: T.lodash.isUndefined(touch[0]) ? '' : touch[0].infectorIdCard,
                        infectorTime: T.lodash.isUndefined(touch[0]) ? '' : (touch[0].infectorTime === null || touch[0].infectorTime === '') ? null : T.moment( new Date(touch[0].infectorTime).getTime()),
                        infectorPoint: T.lodash.isUndefined(touch[0]) ? '' : touch[0].infectorPoint,

                        bodyCondition: T.lodash.isUndefined(currnets[0]) ? '' : currnets[0].bodyCondition,
                        hasSeek: T.lodash.isUndefined(currnets[0]) ? '' : currnets[0].hasSeek,
                        seekHospital: T.lodash.isUndefined(currnets[0]) ? '' : currnets[0].seekHospital,
                        ...
                        controlMeasures: T.lodash.isUndefined(currnets[0]) ? '' : currnets[0].controlMeasures,
                        ...
                        nextMeasures: T.lodash.isUndefined(currnets[0]) ? '' : currnets[0].nextMeasures,
                    };
